...
function(
    ...
    return declare('deploy.widgets.workflow.activity.EnvironmentApprovalTaskActivity',  [BaseActivity], {
        postCreate: function() {
            var self = this;
        ...
        getLabel: function() {
            var result = i18n("Environment Approval");
        ...
        editProperties: function(callback) {
            ...
            var propertyForm = self.createPropertyForm({
                ...
                onSubmit: function(data) {
                    ...
                    self.data.roleRestrictionData.contextType = "ENVIRONMENT";
