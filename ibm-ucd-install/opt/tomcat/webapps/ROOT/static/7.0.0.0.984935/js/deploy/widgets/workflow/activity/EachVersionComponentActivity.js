...
function(
    ...
    return declare('deploy.widgets.workflow.activity.EachVersionComponentActivity',  [BaseActivity], {
        postCreate: function() {
        ...
        getLabel: function() {
            ...
            if (!this.initialized) {
                result += i18n("Run Process For Each Version");
            }
            else {
                ...
                if (childChildData.component && childChildData.component.deleted) {
                    ...
                    result += this.getDisplayName(childChildData.name, childChildData.componentName,
                            childChildData.componentName,
                            i18n("Each Version for %s", childChildData.componentName));

                    if (childChildData.componentProcessName) {
                        result += "\n"+i18n("Run: %s", childChildData.componentProcessName);
                    }
                }
            }
        ...
        editProperties: function(callback) {
            ...
            propertyForm.addField({
                ...
                description: i18n("The maximum number of concurrent processes to run, per component. " +
                        ...
                        "even if many instances of the component are installed. Use -1 for unlimited.")
            });
        ...
        getDefaultName: function(componentName) {
            return i18n("All Versions: \"%s\"", componentName);
        }
    });
});
