...
function(
     ...
     *
     */
    return declare('deploy.widgets.deploymentRequest.RequestResourceChanges',  [_Widget, _TemplatedMixin], {
        templateString: 
            '<div class="requestResourceChanges" style="width: 700px">' +
        ...
        postCreate: function() {
            ...
            var gridRestUrl = bootstrap.restUrl+"deploy/deploymentRequest/"+appState.deploymentRequest.id+"/resourceChanges";
            this.grid = new Table({
                url: gridRestUrl,
                ...
                columns: gridLayout,
                tableConfigKey: "deploymentRequestResourceChange",
