...
function(
     ...
     *
     */
    return declare('deploy.widgets.report.deploymentCount.DeploymentDurationSumReportTable',  [ReportTable], {
        ...
        reportType : 'com.urbancode.ds.subsys.report.domain.deployment_count.DeploymentDurationSumReport',
        ...
        createChart : function(data, aggregationType, domNode){
            ...
            var timeValues = true;
            subtitleOptions.text = i18n("Total Deployment Duration");
