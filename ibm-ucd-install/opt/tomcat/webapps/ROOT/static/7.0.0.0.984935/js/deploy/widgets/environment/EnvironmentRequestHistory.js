...
function(
    ...
    return declare('deploy.widgets.environment.EnvironmentRequestHistory',  [_Widget, _TemplatedMixin], {
        templateString:
            '<div class="environmentRequestHistory">' +
        ...
        postCreate: function() {
            ...
            this.grid = new TreeTable({
                ...
                baseFilters: [{
                    ...
                    type: "eq",
                    className: "UUID",
                    values: [appState.environment.id]
                }],
                columns: gridLayout,
                orderField: "calendarEntry.scheduledDate",
                sortType: "desc",
                tableConfigKey: "environmentProcessHistory"+appState.environment.id,
                noDataMessage: i18n("No process history found for this environment."),
