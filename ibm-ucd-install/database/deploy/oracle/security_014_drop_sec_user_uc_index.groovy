...
String drop_user_uc_index = "drop index sec_user_uc"
String drop_user_uc_constraint = "alter table sec_user drop constraint sec_user_uc"

try {
    sql.execute(drop_user_uc_constraint)
}
catch (Exception e) {
    warn(e)
}
...
try{
    sql.execute(drop_user_uc_index)
}
catch (Exception e) {
    warn(e)
}