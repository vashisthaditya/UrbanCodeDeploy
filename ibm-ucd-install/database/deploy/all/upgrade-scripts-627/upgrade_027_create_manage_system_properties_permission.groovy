...
def createManageSystemPropertiesPermissionSQL = '''
...
sql.execute(createManageSystemPropertiesPermissionSQL)

List<String> roles = getRoleIds()

for (String role : roles) {
    sql.execute(addActionSQL, UUID.randomUUID().toString(), role, '200000000000000000000000001b0018', null)
}